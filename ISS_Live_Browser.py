...
'''Refreshing the data'''
try:
    os.startfile('ISS_Coordinate_Files.exe')
except:
    pass
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        navigate_home_action = QAction(QIcon(os.path.join('icons', 'cil-exit-to-app.png')),
                                            "Homepage", self)
        navigate_home_action.setStatusTip("Back to the Homepage")
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("http://localhost:63342/ISS_Live/mp.html"))
...
# APPLICATION NAME
app.setApplicationName("ISS Live")
# APPLICATION COMPANY NAME
app.setOrganizationName("ISS Live")
# APPLICATION COMPANY ORGANISATION
app.setOrganizationDomain("http://localhost:63342/ISS_Live/mp.html")
